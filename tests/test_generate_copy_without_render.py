...
def test_generate_copy_without_render_extensions() -> None:
        ...
        context={
            'mlpstamps': {
                ...
                '_copy_without_render': [
                    ...
                    '*.txt',
                    '{{mlpstamps.repo_name}}-rendered/README.md',
                ],
            }
        },
    ...
    assert '{{mlpstamps.render_test}}' in file_1
    ...
    assert '{{mlpstamps.render_test}}' in file_3
