...
I created a mlpstamps, but it doesn't work, and I can't figure out why
-------------------------------------------------------------------------

* Try upgrading to mlpstamps 0.8.0, which prints better error
...
You can also use the `_copy_without_render`_ key in your `mlpstamps.json`
file to escape entire files and directories.

.. _`_copy_without_render`: http://mlpstamps.readthedocs.io/en/latest/advanced/copy_without_render.html
